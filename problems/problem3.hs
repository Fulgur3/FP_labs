...
-- Функція для вибору батьків для схрещування
...
-- Функція для вибору батька для схрещування
...
-- Функція для виконання генетичного алгоритму
...
-- Функція для еволюції популяції
...
-- Функція для виконання одного етапу еволюції (вибір, схрещування, мутація)
...
-- Приклад використання генетичного алгоритму для розв'язання задачі комівояджера
main :: IO ()
main = do
